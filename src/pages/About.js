...
const About = () => {
    return (
        <Box sx={{ fontFamily: 'Inter, sans-serif' }}>
            ...
            {/* 1. HERO SECTION: Título Principal con Fondo Impactante */}
            <Box
                sx={{
                    position: 'relative',
                ...
                <Container maxWidth="lg">
                    <Grid container spacing={{ xs: 5, md: 8 }} alignItems="center">
                        ...
                        <Grid item xs={12} md={6}>
                            ...
                            <Typography variant="subtitle1" sx={{ color: ACCENT_GREEN, fontWeight: 'bold', mt: 4 }}>
                                Nuestro Compromiso Legal:
                            </Typography>
                            <Box sx={{ mt: 1, p: 2, bgcolor: LIGHT_GREY, borderLeft: `5px solid ${ACCENT_GREEN}`, color: SUB_TEXT_COLOR, borderRadius: 1, boxShadow: 1 }}>
                                <Typography variant="body2" fontStyle="italic" sx={{ lineHeight: 1.6 }}>
                                ...
                                <Typography variant="caption" display="block" sx={{ mt: 1, color: SUB_TEXT_COLOR }}>
                                    — Extracto del Objeto Social
                                </Typography>
                            </Box>
                        </Grid>
                        ...
                        <Grid item xs={12} md={6}>
                            ...
                            >
                                <img
                                    src="https://placehold.co/800x450/007FC4/FFFFFF?text=CONTAHSA+Equipo" // Placeholder o reemplazar con imagen real
            ...
            <Divider sx={{ my: { xs: 4, md: 8 }, borderColor: LIGHT_GREY }} />
            ...
            <Box sx={{ py: { xs: 8, md: 12 }, px: 3, bgcolor: WHITE }}>
                <Container maxWidth="lg">
                    ...
                    {/* Pilares del Equipo con diseño de tarjeta */}
            ...
            >
                <Container maxWidth="md">
                    <Typography
                        ...
                        component="h2"
                        gutterBottom
                        sx={{ fontWeight: 700, mb: 3, fontSize: { xs: '2rem', sm: '2.5rem' } }}
                    >
                    ...
                    <Button
                        ...
                        sx={{
                            ...
                            color: WHITE,
                            '&:hover': { bgcolor: PRIMARY_MEDIUM, transform: 'scale(1.05)', boxShadow: '0px 15px 35px rgba(0, 0, 0, 0.4)' },
                            transition: '0.3s',
                            borderRadius: '30px',
                            px: { xs: 5, sm: 8 },
                            py: { xs: 1.8, sm: 2.2 },
